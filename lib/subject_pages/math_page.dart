...
import 'package:reddays/data/math_flashcard_data.dart';
...
class _MathPageState extends State<MathPage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Math - Flashcards', style: TextStyle(color: Colors.white)),
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            Text(
              'Review and test your Math knowledge using these flashcards!',
